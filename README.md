# José Moncada — Portfolio (Project Highlights)

Senior Full-Stack Engineer (14+ años). He trabajado en proyectos de distintos giros:

- **Gobierno:** Catastro / trámites y procesos municipales
- **Servicios:** administración de aguas
- **RH:** administración y control de personal
- **Logística:** paquetería e inventarios en almacenes
- **Comercio exterior:** procesos aduanales
- **Financiero:** proyecto Fintech
- **Financiero:** sistema de gestión de créditos (proyecto independiente)

> **Nota (NDA):** gran parte de mi experiencia ha sido en proyectos privados bajo NDA, por lo que no puedo compartir repositorios completos.
> Con gusto puedo explicar arquitectura, decisiones técnicas y retos en entrevista.
...
- **Backend:** Node.js (NestJS/Express), Java (Spring Boot), .NET (Framework/Core)  
- **DB:** PostgreSQL, MySQL, SQL Server, Informix, SQLite  
...
- Análisis y solución de problemas de infraestructura y código.
- Mejoras de calidad, procesos y seguridad.

**Stack:** Node.js, .NET Core, C#, React, Angular, PostgreSQL, MySQL, SQL Server, AWS, Git

### Ilana VA — Cliente: Finvivir
Aplicación para **gestión de créditos (préstamos)** (Líder Técnico).
- App móvil con enrolamiento de clientes mediante **KYC (Incode)**.
- Integración con core de créditos **Mambu**.
